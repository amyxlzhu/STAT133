...
```{r}
no_a <- "[^a]"
length(str_subset(states, no_a)) #query: why does this not work?
...
# is_hex()
is_hex <- function(x) {
  x <- "^[#]([0-9]|[aAbBcCdDeEfF]){6}$"
}
  
#query: is it 6 characters with the hexadecimal digits and letters or 6 characters and one of the letters? 
```
